...
void g_UnityEngine_UI_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(t9 *) * cache->count, 0);
	{
		...
		m3123(tmp, il2cpp_codegen_string_new_wrapper("d4f464c7-9b15-460d-b4bc-2cacd1c1df73"), &m3123_MI);
	...
	}
	{
		...
		m3125(tmp, il2cpp_codegen_string_new_wrapper(""), &m3125_MI);
		cache->attributes[2] = (Il2CppObject*)tmp;
	}
	{
		t674 * tmp;
		tmp = (t674 *)il2cpp_codegen_object_new (&t674_TI);
		m3126(tmp, il2cpp_codegen_string_new_wrapper("Microsoft"), &m3126_MI);
		cache->attributes[3] = (Il2CppObject*)tmp;
	}
	{
		t675 * tmp;
		tmp = (t675 *)il2cpp_codegen_object_new (&t675_TI);
		m3127(tmp, il2cpp_codegen_string_new_wrapper("guisystem"), &m3127_MI);
		cache->attributes[4] = (Il2CppObject*)tmp;
	}
	{
		t676 * tmp;
		tmp = (t676 *)il2cpp_codegen_object_new (&t676_TI);
		m3128(tmp, il2cpp_codegen_string_new_wrapper("Copyright © Microsoft 2013"), &m3128_MI);
	...
	}
	{
		...
		m3130(tmp, il2cpp_codegen_string_new_wrapper("guisystem"), &m3130_MI);
	...
	}
	{
		...
		m3131(tmp, il2cpp_codegen_string_new_wrapper("1.0.0.0"), &m3131_MI);
		cache->attributes[9] = (Il2CppObject*)tmp;
	}
	{
		t680 * tmp;
		tmp = (t680 *)il2cpp_codegen_object_new (&t680_TI);
		m3132(tmp, il2cpp_codegen_string_new_wrapper(""), &m3132_MI);
