...
void g_Mono_Security_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(t9 *) * cache->count, 0);
	{
		...
		m3127(tmp, il2cpp_codegen_string_new_wrapper("(c) 2003-2004 Various Authors"), &m3127_MI);
		cache->attributes[0] = (Il2CppObject*)tmp;
	}
	{
		t672 * tmp;
		tmp = (t672 *)il2cpp_codegen_object_new (&t672_TI);
		m3123(tmp, il2cpp_codegen_string_new_wrapper("Mono.Security.dll"), &m3123_MI);
		cache->attributes[1] = (Il2CppObject*)tmp;
	}
	{
		t675 * tmp;
		tmp = (t675 *)il2cpp_codegen_object_new (&t675_TI);
		m3126(tmp, il2cpp_codegen_string_new_wrapper("MONO CLI"), &m3126_MI);
		cache->attributes[2] = (Il2CppObject*)tmp;
	}
	{
		t678 * tmp;
		tmp = (t678 *)il2cpp_codegen_object_new (&t678_TI);
		m3129(tmp, il2cpp_codegen_string_new_wrapper("Mono.Security.dll"), &m3129_MI);
	...
	}
	{
		...
		m4799(tmp, il2cpp_codegen_string_new_wrapper("../mono.pub"), &m4799_MI);
